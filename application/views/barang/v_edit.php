    ...
    <div class="card card-success">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="berat" class="form-control" placeholder="Berat Satuan Gram" value="<?= $barang->berat ?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambar/'.$barang->gambar)?>" id="gambar_load" width="100px">
                    </div>
                </div>
            </div>
            <div class="form-group">
