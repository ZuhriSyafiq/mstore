                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <span class="badge badge-primary mt-2">menunggu verifikasi</span>

                                    <?php } ?>
                                </td>
                                <td>
                                    <?php if ($value->status_bayar == 1) { ?>
                                        <button class="btn btn-success" data-toggle="modal" data-target="#cek<?= $value->id_transaksi ?>"><i class="fas fa-eye fa-lg"></i></button>
                                        <a href="<?= base_url('admin/proses/' . $value->id_transaksi) ?>" class="btn btn-sm btn-primary">Proses</a>
                                    <?php } ?>
                    ...
                    <table class="table">
                        ...
                        <?php foreach ($pesanan_diproses as $key => $value) { ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($value->status_bayar == 1) { ?>
                                        <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#kirim<?=$value->id_transaksi?>"><i class="fa fa-truck"></i> Kirim</button>
                                    <?php } ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img src="<?= base_url('assets/bukti_bayar/' . $value->bukti_bayar) ?>" class="img-fluid">
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
            ...
            <div class="modal-body">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>No Resi</th>
                        <th>:</th>
                        <th><input class="form-control" name="no_resi" placeholder="No Resi" required></th>
                    </tr>
                </table>
